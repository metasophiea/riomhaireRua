...
Not all the machines have all the tools, and tools can have varying complexity for different machines. Here is a list of all tools, with a general description
