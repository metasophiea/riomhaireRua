...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;The worker uses the worktop to do jobs. The worktop is firstly a place to put bytes down. It is secondly a place to find connections to other tools. These connections are called ports

<p align="center">
    <img width=640" height="376" src="https://raw.githubusercontent.com/metasophiea/riomhaireRua/master/v2/images/4.png">
</p>
